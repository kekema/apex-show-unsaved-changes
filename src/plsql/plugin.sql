...
begin
    ...
    apex_javascript.add_library(
          p_name      => 'lib4x-showunsavedchanges',
    ...
    apex_css.add_file (
        p_name => 'lib4x-showunsavedchanges'||case when v('DEBUG') = 'NO' then '.min' end,
        --p_directory => '#WORKSPACE_FILES#css/'
        p_directory => p_plugin.file_prefix || 'css/'         
    );    

    l_result.javascript_function := 'lib4x.axt.showUnsavedChanges._execute';
